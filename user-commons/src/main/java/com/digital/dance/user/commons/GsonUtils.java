...
public class GsonUtils {
	...
	public static <T> T getJson(String json,Class<T> classOfT){
		return  com.digital.dance.framework.infrastructure.commons.GsonUtils.getJson(json, classOfT);
	}
	
	public static <T> T getJson(String json,Type typeOfT){
		return  com.digital.dance.framework.infrastructure.commons.GsonUtils.getJson(json, typeOfT);
	}
	...
	public static String toJson(Object obj){
		return com.digital.dance.framework.infrastructure.commons.GsonUtils.toJson(obj);
	}
	
	public static String toJsonStr( Object obj ) {
		return com.digital.dance.framework.infrastructure.commons.GsonUtils.toJsonStr( obj );
	}
	...
	public static <T> T toObject( String json, Class<T> clazz ) {
		...
		return com.digital.dance.framework.infrastructure.commons.GsonUtils.toObject( json, clazz );
	}
